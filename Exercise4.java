 ...
 * 
 * In this exercise, you will export results from a Dataflow job to a BigQuery
 * Table.
 */
public class Exercise4 {
  ...
  public static void main(String[] args) {
    Pipeline p =
        Pipeline
                .create(PipelineOptionsFactory.fromArgs(args).withValidation()
                                              .create());
    ...
    p.apply(TextIO.Read.from(filePath + "package_log.txt"))
     ...
     // before executing this command. If you have not created it, use the
     // BigQuery
     // UI in the Developers Console to create the dataset.
     //
     // With the option CREATE_IF_NEEDED, the table will be created if it
     // doesn't
     // already exist.
